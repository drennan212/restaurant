...
const Cart = () => {
    ...
    const createOrder = async (data) =>{
        try{
            const res = await axios.post("https://restaurant-psi-ten.vercel.app/api/orders", data); 
        ...
        <div className={styles.right}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.paymentMethods}>
                  ...
                  <PayPalScriptProvider
                options={{
                    "client-id": "AXBWjrhGObStkg7qwkt4_VkKT7tKL0pUlW2typZDOZb33MPwlz8MKchlUhXb8hWtTzstGIk_2agssS-0",
                    components: "buttons",
                    currency: "USD",
